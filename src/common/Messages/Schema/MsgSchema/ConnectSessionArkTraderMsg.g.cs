...
{
    /// <summary>
    /// Connection for ArkTrader
    /// </summary>
    public sealed partial class ConnectSessionArkTraderMsg
    {
        ...
        private readonly ConnectSessionArkTraderMsg _parentMessage;
        ...
        public ConnectSessionArkTraderMsg()
        {
            _parentMessage = this;
        }
    ...
    public bool PasswordInActingVersion()
    {
        ...
        public const int CompanyNameId = 4;
    ...
    public bool CompanyNameInActingVersion()
    {
        ...
        public const int CompanyNameOffset = 62;
        ...
        public const byte CompanyNameNullValue = (byte)0;
        public const byte CompanyNameMinValue = (byte)32;
        public const byte CompanyNameMaxValue = (byte)126;

        public const int CompanyNameLength = 100;

        public byte GetCompanyName(int index)
        {
            if ((uint) index >= 100)
            {
                ThrowHelper.ThrowIndexOutOfRangeException(index);
        ...
        public void SetCompanyName(int index, byte value)
        {
            if ((uint) index >= 100)
            {
                ThrowHelper.ThrowIndexOutOfRangeException(index);
        ...
        public ReadOnlySpan<byte> CompanyName
        {
            get => _buffer.AsReadOnlySpan<byte>(_offset + 62, CompanyNameLength);
            set => value.CopyTo(_buffer.AsSpan<byte>(_offset + 62, CompanyNameLength));
        }

        public Span<byte> CompanyNameAsSpan()
        {
            return _buffer.AsSpan<byte>(_offset + 62, CompanyNameLength);
        }

        public const string CompanyNameCharacterEncoding = "ASCII";
        public static Encoding CompanyNameResolvedCharacterEncoding = Encoding.GetEncoding(CompanyNameCharacterEncoding);


        public int GetCompanyName(byte[] dst, int dstOffset)
        {
            const int length = 100;
            return GetCompanyName(new Span<byte>(dst, dstOffset, length));
        }
        ...
        public void SetCompanyName(byte[] src, int srcOffset)
        {
            SetCompanyName(new ReadOnlySpan<byte>(src, srcOffset, src.Length - srcOffset));
        }

        public void SetCompanyName(ReadOnlySpan<byte> src)
        {
            const int length = 100;
            if (src.Length > length)
            {
        ...
        {
            _buffer.SetNullTerminatedBytesFromString(CompanyNameResolvedCharacterEncoding, value, _offset + 62, CompanyNameLength, CompanyNameNullValue);
        }
        public string GetCompanyName()
        {
            return _buffer.GetStringFromNullTerminatedBytes(CompanyNameResolvedCharacterEncoding, _offset + 62, CompanyNameLength, CompanyNameNullValue);
        }
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[ConnectSessionArkTraderMsg](sbeTemplateId=");
            builder.Append(ConnectSessionArkTraderMsg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ConnectSessionArkTraderMsg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ConnectSessionArkTraderMsg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ConnectSessionArkTraderMsg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ConnectSessionArkTraderMsg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ConnectSessionArkTraderMsg.BlockLength);
            builder.Append("):");
            ...
            for (int i = 0; i < CompanyNameLength && this.GetCompanyName(i) > 0; ++i)
            {
                builder.Append((char)this.GetCompanyName(i));
            }
