...
{
    /// <summary>
    /// Connection for BJFfeed
    /// </summary>
    public sealed partial class ConnectSessionBJFfeedMsg
    {
        ...
        private readonly ConnectSessionBJFfeedMsg _parentMessage;
        ...
        public ConnectSessionBJFfeedMsg()
        {
            _parentMessage = this;
        }
    ...
    public bool PortInActingVersion()
    {
        ...
        public const int PortOffset = 112;
        ...
        public const byte PortNullValue = (byte)255;
        public const byte PortMinValue = (byte)0;
        public const byte PortMaxValue = (byte)254;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[ConnectSessionBJFfeedMsg](sbeTemplateId=");
            builder.Append(ConnectSessionBJFfeedMsg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ConnectSessionBJFfeedMsg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ConnectSessionBJFfeedMsg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ConnectSessionBJFfeedMsg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ConnectSessionBJFfeedMsg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ConnectSessionBJFfeedMsg.BlockLength);
            builder.Append("):");
