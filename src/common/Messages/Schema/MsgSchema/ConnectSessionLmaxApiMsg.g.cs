...
{
    /// <summary>
    /// Connection for LmaxApi
    /// </summary>
    public sealed partial class ConnectSessionLmaxApiMsg
    {
        ...
        private readonly ConnectSessionLmaxApiMsg _parentMessage;
        ...
        public ConnectSessionLmaxApiMsg()
        {
            _parentMessage = this;
        }
    ...
    public bool HostInActingVersion()
    {
        ...
        public const int HostOffset = 62;
        ...
        {
            get => _buffer.AsReadOnlySpan<byte>(_offset + 62, HostLength);
            set => value.CopyTo(_buffer.AsSpan<byte>(_offset + 62, HostLength));
        }

        public Span<byte> HostAsSpan()
        {
            return _buffer.AsSpan<byte>(_offset + 62, HostLength);
        }
        ...
        {
            _buffer.SetNullTerminatedBytesFromString(HostResolvedCharacterEncoding, value, _offset + 62, HostLength, HostNullValue);
        }
        public string GetHost()
        {
            return _buffer.GetStringFromNullTerminatedBytes(HostResolvedCharacterEncoding, _offset + 62, HostLength, HostNullValue);
        }

        public const int SessionTypeId = 5;
    public const int SessionTypeSinceVersion = 0;
    public const int SessionTypeDeprecated = 0;
    public bool SessionTypeInActingVersion()
    {
        return _actingVersion >= SessionTypeSinceVersion;
    }

        public const int SessionTypeOffset = 112;

        public static string SessionTypeMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public SessionAccountType SessionType
        {
            get
            {
                return (SessionAccountType)_buffer.Uint8Get(_offset + 112);
            }
            set
            {
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[ConnectSessionLmaxApiMsg](sbeTemplateId=");
            builder.Append(ConnectSessionLmaxApiMsg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ConnectSessionLmaxApiMsg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ConnectSessionLmaxApiMsg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ConnectSessionLmaxApiMsg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ConnectSessionLmaxApiMsg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ConnectSessionLmaxApiMsg.BlockLength);
            builder.Append("):");
