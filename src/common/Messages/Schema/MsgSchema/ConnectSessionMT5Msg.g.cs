...
namespace MsgSchema
{
    ...
    /// Connection for MT5
    /// </summary>
    public sealed partial class ConnectSessionMT5Msg
    {
        ...
        private readonly ConnectSessionMT5Msg _parentMessage;
    ...
    public bool PortInActingVersion()
    {
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[ConnectSessionMT5Msg](sbeTemplateId=");
            builder.Append(ConnectSessionMT5Msg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ConnectSessionMT5Msg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ConnectSessionMT5Msg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ConnectSessionMT5Msg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ConnectSessionMT5Msg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ConnectSessionMT5Msg.BlockLength);
            builder.Append("):");
