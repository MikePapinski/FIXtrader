...
{
    /// <summary>
    /// Connection for OneZeroFix
    /// </summary>
    public sealed partial class ConnectSessionOneZeroFixMsg
    {
        ...
        private readonly ConnectSessionOneZeroFixMsg _parentMessage;
        ...
        public ConnectSessionOneZeroFixMsg()
        {
            _parentMessage = this;
        }
    ...
    public bool UseSslInActingVersion()
    {
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[ConnectSessionOneZeroFixMsg](sbeTemplateId=");
            builder.Append(ConnectSessionOneZeroFixMsg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ConnectSessionOneZeroFixMsg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ConnectSessionOneZeroFixMsg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ConnectSessionOneZeroFixMsg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ConnectSessionOneZeroFixMsg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ConnectSessionOneZeroFixMsg.BlockLength);
            builder.Append("):");
