...
namespace MsgSchema
{
    ...
    {
        public const ushort SbeSchemaId = (ushort)6;
        ...
        public const long DecodeTimestampNullValue = -9223372036854775808L;
        public const long DecodeTimestampMinValue = -9223372036854775807L;
        public const long DecodeTimestampMaxValue = 9223372036854775807L;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append('|');
            builder.Append("DecodeTimestamp=");
            builder.Append(this.DecodeTimestamp);
            builder.Append(')');
