...
{
    /// <summary>
    /// Subscription msg response
    /// </summary>
    public sealed partial class SubscribeMarketDataResponseMsg
    {
        ...
        private readonly SubscribeMarketDataResponseMsg _parentMessage;
        ...
        public SubscribeMarketDataResponseMsg()
        {
            _parentMessage = this;
        }
    ...
    public bool ExchangeNameInActingVersion()
    {
        ...
        public const int SubscriptionLevelId = 7;
    public const int SubscriptionLevelSinceVersion = 0;
    public const int SubscriptionLevelDeprecated = 0;
    public bool SubscriptionLevelInActingVersion()
    {
        return _actingVersion >= SubscriptionLevelSinceVersion;
    }

        public const int SubscriptionLevelOffset = 48;

        public static string SubscriptionLevelMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public MarketDataSubscriptionLevel SubscriptionLevel
        {
            get
            {
                return (MarketDataSubscriptionLevel)_buffer.Uint8Get(_offset + 48);
            }
            set
            {
        ...
        public const int SubscribeMDStatusId = 8;
    ...
    public bool SubscribeMDStatusInActingVersion()
    {
        ...
        public const int SubscribeMDStatusOffset = 49;
        ...
        public SubscribeMDStatus SubscribeMDStatus
        {
            get
            {
                return (SubscribeMDStatus)_buffer.Uint8Get(_offset + 49);
            }
            set
            {
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[SubscribeMarketDataResponseMsg](sbeTemplateId=");
            builder.Append(SubscribeMarketDataResponseMsg.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(SubscribeMarketDataResponseMsg.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != SubscribeMarketDataResponseMsg.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(SubscribeMarketDataResponseMsg.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != SubscribeMarketDataResponseMsg.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(SubscribeMarketDataResponseMsg.BlockLength);
            builder.Append("):");
            ...
            builder.Append(this.SubscriptionLevel);
            builder.Append('|');
