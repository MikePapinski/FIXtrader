...
namespace MsgSchema
{
    ...
    /// just test msg
    /// </summary>
    public sealed partial class TestSchemaMsgMde
    {
        ...
        private readonly TestSchemaMsgMde _parentMessage;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[TestSchemaMsgMde](sbeTemplateId=");
            builder.Append(TestSchemaMsgMde.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TestSchemaMsgMde.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TestSchemaMsgMde.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgMde.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TestSchemaMsgMde.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgMde.BlockLength);
            builder.Append("):");
