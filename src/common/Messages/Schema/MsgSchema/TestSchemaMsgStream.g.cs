...
namespace MsgSchema
{
    ...
    /// just test msg
    /// </summary>
    public sealed partial class TestSchemaMsgStream
    {
        ...
        private readonly TestSchemaMsgStream _parentMessage;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[TestSchemaMsgStream](sbeTemplateId=");
            builder.Append(TestSchemaMsgStream.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TestSchemaMsgStream.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TestSchemaMsgStream.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgStream.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TestSchemaMsgStream.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgStream.BlockLength);
            builder.Append("):");
