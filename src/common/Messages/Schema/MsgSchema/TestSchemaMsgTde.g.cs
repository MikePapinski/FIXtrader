...
namespace MsgSchema
{
    ...
    /// just test msg
    /// </summary>
    public sealed partial class TestSchemaMsgTde
    {
        ...
        private readonly TestSchemaMsgTde _parentMessage;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[TestSchemaMsgTde](sbeTemplateId=");
            builder.Append(TestSchemaMsgTde.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TestSchemaMsgTde.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TestSchemaMsgTde.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgTde.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TestSchemaMsgTde.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TestSchemaMsgTde.BlockLength);
            builder.Append("):");
